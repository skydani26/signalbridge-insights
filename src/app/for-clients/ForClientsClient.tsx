...
export default function ForClientsClient() {
    useEffect(() => {
        ...
        <main>
            ...
            <SectionWrapper id="services">
                <div className={styles.reveal} style={{ textAlign: 'center', marginBottom: '64px' }}>
                    ...
                    <h2 className={styles.sectionTitleStandard}>Strategic Research Solutions</h2>
                    <p className={styles.sectionSubtitleStandard}>Precision-engineered engagement formats for institutional decision makers</p>
                </div>
            ...
            <SectionWrapper id="trust" background="gray">
                <div className={styles.reveal} style={{ textAlign: 'center', marginBottom: '48px' }}>
                    <h2 className={styles.sectionTitleStandard}>Why Clients Choose Us</h2>
                    <p className={styles.sectionSubtitleStandard}>Fast, compliant, and high-quality expert access across every engagement type</p>
                </div>
            ...
            <SectionWrapper id="geographic-reach" background="gray">
                <div className={styles.reveal} style={{ textAlign: 'center', marginBottom: '64px' }}>
                    <h2 className={styles.sectionTitleStandard}>Global Reach, Local Depth</h2>
                    <p className={styles.sectionSubtitleStandard}>Connecting global capital with localized expertise across 100+ countries.</p>
                </div>
            ...
            <SectionWrapper id="use-cases">
                <div className={styles.reveal} style={{ marginBottom: '64px' }}>
                    ...
                    <h2 className={styles.sectionTitleStandard} style={{ textAlign: 'left', margin: '16px 0 24px' }}>How Clients Use SignalBridge</h2>
                    <p className={styles.sectionSubtitleStandard} style={{ textAlign: 'left', maxWidth: '700px' }}>
