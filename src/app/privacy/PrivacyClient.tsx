            ...
            <div className={styles.contentContainer}>
                <div className={`${styles.privacySection} ${styles.reveal}`}>
                    ...
                    <div className={styles.privacyText}>
                        ...
                        <p>
                            We operate under a "Privacy by Design" philosophy, ensuring that data minification and encryption are integrated into every stage of the expert-client matching lifecycle.
                        </p>
                    </div>
                </div>
